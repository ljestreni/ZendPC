            ...
            header={
                ...
                >
                    ...
                    <h2 className="text-4xl font-black italic tracking-tighter text-white uppercase leading-none mb-2">
                        Desplegar <span className="text-emerald-500">Nuevo Sector</span>
                    </h2>
                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] flex items-center gap-2">
                        <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                        Inicialización de Rama Logística del Catálogo
                    </p>
                </motion.div>
            }
        >
            <Head title="Nuevo Sector" />
                ...
                >
                    ...
                    <form onSubmit={submit} className="space-y-8 relative z-10">
                        <div className="space-y-6">
                            <div>
                                ...
                                <input
                                    id="name"
                                    type="text"
                                    placeholder="EJ: PROCESADORES, GPU..."
                                    value={data.name}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    placeholder="Definición logística del sector para el usuario final..."
                            ...
                            <div>
                                ...
                                <input
                                    id="image"
                                    type="text"
                                    placeholder="https://assets.zendpc.com/cat/icon.svg"
                                    value={data.image}
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-10 border-t border-white/5 mt-10">
                            ...
                            >
                                {processing ? 'INICIALIZANDO...' : 'DESPLEGAR_SECTOR'}
                            </motion.button>
                        </div>
                    </form>
                </motion.div>
