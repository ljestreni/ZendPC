...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-dark-bg flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <Head title="Registro - ZendPC" />

            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 flex flex-col items-center">
                <Link href="/" className="flex items-center gap-3">
                    <img src="/logo.png" alt="ZendPC Logo" className="w-16 h-16 object-contain drop-shadow-[0_0_15px_rgba(99,102,241,0.5)] rounded-2xl" />
                ...
                <p className="mt-2 text-center text-sm text-slate-400">
                    O{' '}
                    <Link href={route('login')} className="font-medium text-zend-400 hover:text-zend-300 transition-colors">
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div>
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full btn-success flex justify-center py-3 text-lg"
                            >
                                Registrarse Ahora
                            </button>
                        </div>
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-dark-bg/80 text-slate-400 backdrop-blur-sm">O regístrate con</span>
                            </div>
                        </div>
